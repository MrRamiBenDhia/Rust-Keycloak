...
//         r#"INSERT INTO realm (id, name, description, enabled, verifyEmail, rememberMe) VALUES (?, ?, ?, ?, ?, ?)"#,
//         id.clone(),
//         body.name.clone(),
...
//     let query_result = sqlx::query!(
//         r#"UPDATE realm SET name = ?, description = ?, enabled = ?, verifyEmail = ?, rememberMe = ? WHERE id = ?"#,
...
//         verifyEmail: realm.verify_email,
//         rememberMe: realm.remember_me,
//     }
// }
